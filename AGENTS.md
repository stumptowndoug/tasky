...
**IMPORTANT - Understanding Board Context:**
All MCP tool responses include "Available boards and columns" at the end. Use this to understand which boards exist and their column structures. When creating tasks, ask the user which board to use if unclear from context.
